...
// $altiriaSMS->setLogin('juankarmjgs');
// $altiriaSMS->setPassword('ZZ');
// Descomentar para utilizar la autentificaci�n mediante apikey
$altiriaSMS->setApikey('PnR7VNW7Gj');
$altiriaSMS->setApisecret('upbda7sbr9');
